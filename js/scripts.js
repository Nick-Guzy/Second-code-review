window.onload = function(){
  ...
  let superhero4 = (document.querySelector('input:nth-of-type(3)').value);
  let superhero5 = (document.querySelector('input:nth-of-type(3)').value);
  let superhero6 = (document.querySelector('input:nth-of-type(3)').value);
  let superhero7 = (document.querySelector('input:nth-of-type(3)').value);
  let superherotype;
